 ...
 */
 ...
 !(async() => {
     ...
     $.authorCode = await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/AuthorCode/main/jd_nnfls.json')
     if (!$.authorCode) {
         $.http.get({url: 'https://purge.jsdelivr.net/gh/FearNoManButGod/AuthorCode@main/jd_nnfls.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
         await $.wait(1000)
         $.authorCode = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/FearNoManButGod/AuthorCode@main/jd_nnfls.json') || []
     }
     shareCodes = [...new Set([...($.authorCode || [])]), ...shareCodes];
