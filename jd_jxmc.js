...
!(async () => {
  ...
  $.res = await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/AuthorCode/main/jd_jxmc.json')
  if (!$.res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/FearNoManButGod/AuthorCode@main/jd_jxmc.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    $.res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/FearNoManButGod/AuthorCode@main/jd_jxmc.json')
  }
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if (readShareCodeRes && readShareCodeRes.code === 200) {
      $.newShareCodes = [...new Set([ ...($.res || []), ...$.inviteCodeList, ...(readShareCodeRes.data || [])])];
    } else {
