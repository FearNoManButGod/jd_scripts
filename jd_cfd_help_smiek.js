/*
cron "0 0,1,9,14,18 * * *" script-path=https://raw.githubusercontent.com/smiek2121/scripts/master/gua_wealth_island_help.js,tag=财富大陆互助
  默认按账号顺序提交
...
!(async () => {
  ...
  $.InviteLists.push(...$.strMyShareIds,...$.InviteList);
...
async function run() {
  try{
    ...
    if($.HomeInfo){
      ...
      await uploadShareCode($.HomeInfo.strMyShareId);
