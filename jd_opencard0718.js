...
All变量适用
————————————————
入口：[ 酷玩一夏 冰爽放价 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/8938022?activityId=dzlhkkde95c4481a4859f30fa6f5868&shareUuid=5aad9c300c514d68b163a509c634d0fa)]
...
opencard_addSku = $.isNode() ? (process.env.opencard_addSku134 ? process.env.opencard_addSku134 : `${opencard_addSku}`) : ($.getdata('opencard_addSku134') ? $.getdata('opencard_addSku134') : `${opencard_addSku}`);
...
opencard = $.isNode();
openwait = $.isNode() ? (process.env.openwait134 ? process.env.openwait134 : `${openwait}`) : ($.getdata('openwait134') ? $.getdata('openwait134') : `${openwait}`);
...
opencard_draw = $.isNode() ? (process.env.opencard_draw134 ? process.env.opencard_draw134 : opencard_draw) : ($.getdata('opencard_draw134') ? $.getdata('opencard_draw134') : opencard_draw);
...
!(async () => {
  if ($.isNode()) {
    if(opencard+"" != "true"){
      console.log('如需执行脚本请设置环境变量[opencard134]为"true"')
    }
    if(opencard+"" != "true"){
      return
    }
  ...
  $.shareUuid = "5a1f8eea11824a0d8b42303d244930a3"
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  let shareUuidArr = [$.shareUuid,'5a1f8eea11824a0d8b42303d244930a3','2e5f6f9c7aec4161b32e8824c6d970b0','fdde0fcd259648f8a25d8e83c08806d6']
...
async function run() {
  try {
    ...
    }else console.log('如需抽奖请设置环境变量[opencard_draw134]为"3" 3为次数');
